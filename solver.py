#date 110420 1034 1942(visdom related lines are changed as comment with ## symbols)
    ...
    def train(self):
        ...
        for e in range(self.epoch):
            ...
            for idx, (images, labels) in enumerate(self.data_loader['train']):
                ...
                balance = (self.gamma*D_loss_real - D_loss_fake).data.item()
                ...
                if self.global_iter%self.timestep == 0:
                ...
                if self.global_iter%1000 == 0:
                    ...
                    print('iter:{:d}, M:{:.3f}'.format(self.global_iter, M_global.item()))
                    ##print('D_loss_real:{:.3f}, D_loss_fake:{:.3f}, G_loss:{:.3f}'.format(
                        ##D_loss_real.data[0],
                        ##D_loss_fake.data[0],
                        ##G_loss.data[0]))
                    print('D_loss_real:{:.3f}, D_loss_fake:{:.3f}, G_loss:{:.3f}'.format(
                        D_loss_real.data.item(),
                        D_loss_fake.data.item(),
                        G_loss.data.item()))
